...
export default function BookExperience() {
    return (
        ...
        >
            <div className="absolute inset-0 bg-gradient-to-b from-cream to-cream-200" />
            <div className="organic-blob bg-rose top-0 right-0 w-[420px] h-[420px] rounded-full" />
            <div className="organic-blob bg-sage-200 bottom-0 left-0 w-[480px] h-[480px] rounded-full" />
            ...
            <div className="relative max-w-6xl mx-auto px-6 md:px-10 text-center">
                ...
                <Reveal delay={0.1}>
                    <h2 className="font-serif text-sage text-5xl sm:text-6xl md:text-7xl font-light tracking-tight leading-[1.05]">
                        Ready to <em className="text-rose-dark">Glow?</em>
                    </h2>
                </Reveal>
                <Reveal delay={0.2}>
                ...
                <Reveal delay={0.3}>
                    <motion.a
                        ...
                        whileTap={{ scale: 0.97 }}
                        className="btn-ripple inline-flex items-center gap-3 mt-10 bg-sage hover:bg-sage-600 text-cream rounded-full px-10 py-5 text-base font-medium tracking-[0.15em] uppercase shadow-xl transition-colors duration-300"
